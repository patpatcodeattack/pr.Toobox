...
,
						...
						"tags" : "",
						"style" : "",
						"subpatcher_template" : "Toolboxpatcher",
						"assistshowspatchername" : 0,
						"boxes" : [ 							{
								"box" : 								{
									"id" : "obj-15",
									...
									"patching_rect" : [ 51.0, 84.0, 84.0, 22.0 ],
									"text" : "mc.unpack~ 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "multichannelsignal" ],
									"patching_rect" : [ 91.75, 382.0, 70.0, 22.0 ],
									"text" : "mc.pack~ 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 466.0, 143.0, 44.0, 21.0 ],
									"text" : "cycle~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 349.0, 198.0, 32.5, 21.0 ],
									"text" : "*~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 213.0, 100.0, 44.0, 21.0 ],
									"text" : "cycle~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 110.5, 191.0, 32.5, 21.0 ],
									"text" : "*~"
								}
...
,
					"patching_rect" : [ 28.5, 312.0, 119.5, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 98.5, 207.0, 64.0, 22.0 ],
					"text" : "s #0_state"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "", "", "", "", "", "" ],
					"patching_rect" : [ 98.5, 155.0, 196.0, 22.0 ],
					"text" : "route state rateL rateR ampL ampR"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 248.5, 604.0, 42.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : ""
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 72.5, 604.0, 166.0, 22.0 ],
					"text" : "mc.send~ #1-pr.tremalo-out 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "multichannelsignal", "" ],
					"patching_rect" : [ 22.5, 120.0, 151.0, 22.0 ],
					"text" : "signalrouter2 #1 pr.tremalo",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 58.5, 30.0, 171.0, 22.0 ],
					"text" : "mc.receive~ #1-pr.tremalo-in 2"
				}
