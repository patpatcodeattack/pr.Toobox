...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 378.0, 758.0, 170.0, 22.0 ],
					"text" : "mc.send~ #1-pr.delay5-out5 5"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 310.0, 326.0, 150.0, 74.0 ],
					"text" : "for each delay add thhat number before the value\n\neg power 1 1\ndelayL 1 500"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 310.0, 285.0, 150.0, 33.0 ],
					"text" : "power delayL delayR feedback"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 314.5, 758.0, 42.0, 22.0 ],
					"text" : "out~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 115.0, 758.0, 164.0, 22.0 ],
					"text" : "mc.send~ #1-pr.delay5-out 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 65.0, 754.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 112.5, 25.0, 169.0, 22.0 ],
					"text" : "mc.receive~ #1-pr.delay5-in 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 299.5, 25.0, 28.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 76.5, 25.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 678.5, 522.5, 312.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 625.0, 522.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 567.0, 553.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 507.0, 593.0, 53.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 507.0, 492.0, 137.0, 23.0 ],
					"text" : "thispoly~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 567.0, 593.0, 285.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 589.5, 553.0, 220.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 507.0, 393.0, 48.0, 22.0 ],
					"text" : "pipe 60"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 507.0, 365.0, 82.0, 22.0 ],
					"text" : "r #0_state"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 507.0, 430.333332300186157, 29.5, 22.0 ],
					"text" : "!- 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 507.0, 456.0, 57.0, 23.0 ],
					"text" : "mute $1"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 354.0, 215.0, 101.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 216.0, 239.0, 101.0, 22.0 ],
									"text" : "prepend setvalue"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 113.0, 215.0, 101.0, 22.0 ],
									"text" : "prepend setvalue"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "", "", "", "", "" ],
									"patching_rect" : [ 50.0, 82.0, 203.0, 22.0 ],
									"text" : "route power delayL delayR feedback"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 46.0, 341.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 143.0, 341.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 356.0, 341.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 176.75, 304.0, 72.25, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 72.0, 507.5, 92.0, 22.0 ],
					"text" : "mc.mixdown~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 151.0, 251.0, 65.0, 22.0 ],
					"text" : "mc.dup~ 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 72.0, 251.0, 65.0, 22.0 ],
					"text" : "mc.dup~ 5"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 72.0, 186.0, 84.0, 22.0 ],
					"text" : "mc.unpack~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 72.0, 468.5, 90.0, 22.0 ],
					"text" : "mc.combine~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 72.0, 342.5, 177.0, 22.0 ],
					"text" : "mc.gen~ steroDelay @chans 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "multichannelsignal", "" ],
					"patching_rect" : [ 72.0, 126.0, 231.0, 22.0 ],
					"text" : "signalrouter2 #1 -5delay @doublemono 1 "
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 516.5, 453.0, 516.5, 455.0 ],
					"source" : [ "obj-178", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 81.5, 424.0, 382.0, 424.0, 382.0, 599.0, 387.5, 599.0 ],
					"order" : 0,
					"source" : [ "obj-36", 0 ]
				}
