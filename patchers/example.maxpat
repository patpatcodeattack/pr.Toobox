...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 92.0, 30.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 282.0, 597.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 886.0, 131.0, 167.0, 22.0 ],
					"text" : "replace list texas ohio Kansas"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 423.0, 446.0, 153.0, 60.0 ],
					"text" : "sending a dump message will update the matrix control object to reflect the current status of the matrix"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 465.0, 207.0, 150.0, 60.0 ],
					"text" : "you can either use the xbar or the matrix control\nmust be connected to pr.matrix~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 823.0, 41.0, 157.0, 74.0 ],
					"text" : "if you need to loadbang the list into the dict, then you will need to send a bang to all objects after for correct sequencing"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 816.0, 186.0, 150.0, 47.0 ],
					"text" : "dict is embeded so everything is already loaded. "
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 423.0, 395.5, 35.0, 22.0 ],
					"text" : "1 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 389.0, 395.5, 35.0, 22.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 389.0, 360.5, 197.0, 33.0 ],
					"text" : "you can send message such as clear or dump to the matrix"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 160.0, 351.0, 234.0, 22.0 ],
					"text" : "pr.XbarMaker comp list @inlet 1 @outlet 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 123.0, 670.0, 190.0, 22.0 ],
					"text" : "pr.matrix~ comp list inlet 1 outlet 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 752.0, 91.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					"args" : [ "comp", "list", "@inlet", 1, "@outlet", 1 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
					...
					"patching_rect" : [ 92.0, 59.0, 307.0, 272.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 123.0, 714.0, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 123.0, 868.0, 54.0, 22.0 ],
					"text" : "mc.dac~"
				}
...
, 			{
				"box" : 				{
					...
					"data" : 					{
						"clips" : [ 							{
								"absolutepath" : "Mac:/Users/pat/Desktop/pizzA3sec.wav",
								"filename" : "pizzA3sec.wav",
								"filekind" : "audiofile",
								"id" : "u178001629",
								"loop" : 1,
								"content_state" : 								{
...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 123.0, 587.0, 150.0, 30.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 752.0, 131.0, 124.0, 22.0 ],
					"text" : "replace list texas ohio"
				}
...
,
					...
					"patching_rect" : [ 752.0, 183.0, 60.0, 22.0 ],
