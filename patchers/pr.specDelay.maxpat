...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 22.5, 289.0, 70.0, 22.0 ],
					"text" : "mc.pack~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 87.5, 250.0, 65.0, 22.0 ],
					"text" : "transposer"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 22.5, 179.0, 84.0, 22.0 ],
					"text" : "mc.unpack~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 22.5, 226.0, 65.0, 22.0 ],
					"text" : "transposer"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 7,
					"outlettype" : [ "", "", "", "", "", "", "" ],
					"patching_rect" : [ 98.5, 352.0, 365.0, 22.0 ],
					"text" : "route delayrange delays feedbacks feedbackamps state Transpose"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 22.5, 501.5, 233.0, 22.0 ],
					"text" : "mc.pfft~ M4L.delay.pfft~ 1024 4 args 5000"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 327.300000000000011, 400.0, 84.0, 22.0 ],
					"text" : "s #0_state"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 309.0, 751.0, 42.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 61.0, 751.0, 195.0, 22.0 ],
					"text" : "mc.send~ #1-pr.specDelay-out 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.5, 751.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "multichannelsignal", "" ],
					"patching_rect" : [ 22.5, 120.0, 181.0, 22.0 ],
					"text" : "signalrouter2 #1 pr.specDelay",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 58.5, 30.0, 200.0, 22.0 ],
					"text" : "mc.receive~ #1-pr.specDelay-in 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 273.5, 30.0, 28.0, 22.0 ],
					"text" : "in 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 813.5, 590.5, 312.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 760.0, 590.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 702.0, 621.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 642.0, 661.0, 53.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 642.0, 560.0, 137.0, 23.0 ],
					"text" : "thispoly~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 702.0, 661.0, 285.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 724.5, 621.0, 220.0, 36.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 642.0, 461.0, 48.0, 22.0 ],
					"text" : "pipe 60"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 642.0, 433.0, 82.0, 22.0 ],
					"text" : "r #0_state"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 642.0, 498.333332300186157, 29.5, 22.0 ],
					"text" : "!- 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 642.0, 524.0, 57.0, 23.0 ],
					"text" : "mute $1"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-211", 0 ],
					"midpoints" : [ 283.0, 82.0, 32.0, 82.0 ],
					"source" : [ "obj-170", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 651.5, 521.0, 651.5, 523.0 ],
					"source" : [ "obj-178", 0 ]
				}
